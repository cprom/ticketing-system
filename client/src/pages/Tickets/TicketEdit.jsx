...
const TicketEdit = () => {
    ...
    const handleUpdateBtnClick = async () => {
        try {
            updateTicket(title, description, currentUserId, assignToId, priorityId, categoryId, statusId, id );
            navigate(`/tickets/${id}`);
        }
        catch (error) {
            console.log(error);
    ...
    if(ticketDataError){
        console.log(`ticketData Fetching Error: ${ticketDataError}`)
    }
    ...
    if (ticketData) {
      form.setFieldsValue({
        ...
        PriorityId: ticketData.PriorityName,
        CategoryId: ticketData.CategoryName,
        StatusId: ticketData.StatusName
      });
    }
  }, [ticketData, form]);
...
const updateTicket = async (title, description, currentUserId, assignToId, priorityId, categoryId, statusId, id ) => {
  let headersList = {
